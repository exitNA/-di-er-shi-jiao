...
export function AgentWorkspaceLayout({
  ...
  return (
    <div ref={container} className="h-full min-h-0">
      ...
      </div><div className="h-[calc(100%_-_3.5rem)] min-h-0">{mobileView === "conversation" ? conversation : findings}</div></> : <div className="grid h-full min-h-0" style={{ gridTemplateColumns: `${leftWidth}fr 13px ${100 - leftWidth}fr` }}>
